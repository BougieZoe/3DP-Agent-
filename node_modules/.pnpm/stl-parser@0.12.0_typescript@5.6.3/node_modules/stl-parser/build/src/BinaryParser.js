...
export default class BinaryParser extends stream.Transform {
    ...
    _flush(done) {
        if (this.countedFaces === 0) {
            ...
            this.emit("warning", `Number of specified faces (${this.faceCounter}) and \
        ...
        while (this.cursor <= this.internalBuffer.length) {
            ...
            if ((this.cursor =
                ...
                this.currentFace = {
                    ...
                    normal: new Vector(this.internalBuffer.readFloatLE(this.cursor), this.internalBuffer.readFloatLE((this.cursor += this.coordinateByteCount)), this.internalBuffer.readFloatLE((this.cursor += this.coordinateByteCount))),
                    vertices: [],
                };
                for (var i = 0; i <= 2; i++) {
                    this.currentFace.vertices.push(new Vector(this.internalBuffer.readFloatLE((this.cursor += this.coordinateByteCount)), this.internalBuffer.readFloatLE((this.cursor += this.coordinateByteCount)), this.internalBuffer.readFloatLE((this.cursor += this.coordinateByteCount))));
                }
