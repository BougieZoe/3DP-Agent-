...
export default class AsciiParser extends Transform {
    ...
    _parseCoordinate(word, type) {
        ...
        try {
            ...
            this.emit("warning", `Unexpected '${word}' instead of ${type} value ` +
    ...
    _processWord(word) {
        ...
        if (word === "vertex") {
            if (this.last === "vertex-z" || this.last === "loop") {
                ...
                this.emit("warning", `Unexpected vertex after ${this.last} ` +
        ...
        if (word === "facet") {
            ...
            if (this.last === "solid") {
                ...
                this.emit("warning", `Unexpected facet after ${this.last} ` +
                    `in face ${this.currentFace.number} in line ${this.lineCounter}`);
            }
            this.last = "facet";
            return;
        ...
        if (word === "outer") {
            if (this.last === "normal-z") {
                ...
                this.emit("warning", `Unexpected outer after ${this.last} ` +
                    `in face ${this.currentFace?.number} in line ${this.lineCounter}`);
            }
        }
        if (word === "loop") {
            if (this.last !== "outer") {
                this.emit("warning", `Unexpected loop after ${this.last} ` +
                    `in face ${this.currentFace?.number} in line ${this.lineCounter}`);
            }
            this.last = "loop";
            return;
        ...
        if (word === "endloop") {
            if (this.last !== "vertex-z") {
                this.emit("warning", `Unexpected endloop after ${this.last} ` +
                    `in face ${this.currentFace?.number} in line ${this.lineCounter}`);
            }
            else if (this.currentFace?.vertices.length !== 3) {
                this.emit("warning", `Face ${this.currentFace?.number} has ` +
        ...
        if (word === "endfacet") {
            if (this.last === "endloop") {
                ...
                this.emit("warning", `Unexpected endfacet after ${this.last} ` +
                    `in face ${this.currentFace?.number} in line ${this.lineCounter}`);
            }
            this.last = "endfacet";
            return;
        ...
        if (word === "endsolid") {
            ...
            if (this.last === "endfacet" || this.last === "solid") {
                ...
                this.emit("warning", `Unexpected endsolid after ${this.last} ` +
                    `in face ${this.currentFace?.number} in line ${this.lineCounter}`);
            }
            this.last = "endsolid";
            return;
        ...
        if (word === "solid") {
            if (this.last === "root" || this.last === "endsolid") {
                ...
                this.emit("warning", `Unexpected solid after ${this.last} ` +
                    `in face ${this.currentFace?.number} in line ${this.lineCounter}`);
            }
            this.last = "solid";
            return;
    ...
    _flush(done) {
        ...
        if (Boolean(this.currentModel.endName) !== //
            Boolean(this.currentModel.name)) {
            this.emit("warning", `Solid name (\"${this.currentModel.name.substr(0, 50)}\") ` +
